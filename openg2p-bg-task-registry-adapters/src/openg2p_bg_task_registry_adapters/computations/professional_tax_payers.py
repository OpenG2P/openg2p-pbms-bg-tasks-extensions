...
class RegistryProfessionalTaxPayers(RegistryInterface):
    """Fetches professional_tax_payers data and computes summary statistics"""
    ...
    def get_is_registant_entitled(
        ...
        sql_query_with_registrant_id = self.construct_get_is_registrant_entitled_sql_query(
            registrant_id, "professional_tax_payers", sql_query
        )
    ...
    def get_entitlement_multiplier(
        ...
        sql_query = self.construct_multiplier_sql_query(
            multiplier, target_registry="professional_tax_payers"
        )
