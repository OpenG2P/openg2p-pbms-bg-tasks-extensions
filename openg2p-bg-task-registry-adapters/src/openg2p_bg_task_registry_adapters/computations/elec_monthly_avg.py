...
class RegistryElecMonthlyAvg(RegistryInterface):
    """Fetches elec_monthly_avg data and computes summary statistics"""
    ...
    def get_is_registant_entitled(
        ...
        sql_query_with_registrant_id = self.construct_get_is_registrant_entitled_sql_query(
            registrant_id, "elec_monthly_avg", sql_query
        )
    ...
    def get_entitlement_multiplier(
        ...
        sql_query = self.construct_multiplier_sql_query(
            multiplier, target_registry="elec_monthly_avg"
        )
